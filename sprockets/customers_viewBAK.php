...
<?php
if(isset($_GET['id']))//most common way to send data
{
	$id = (int)$_GET['id'];//cast, like a function but more brutal. Will take whatever comes in and turns it into a number 
}else{
...
<?php include 'includes/header.php'; ?> //just shows HTML
